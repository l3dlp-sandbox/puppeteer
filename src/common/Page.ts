...
export class Page extends EventEmitter {
  ...
  async waitForNetworkIdle(
    ...
    let abortRejectCallback: (arg0: Error) => void;
  ...
  async waitForFrame(
    ...
    if (helper.isString(urlOrPredicate)) {
      ...
      predicate = (frame: Frame) => Promise.resolve(urlOrPredicate(frame));
    }
  ...
  async screenshot(options: ScreenshotOptions = {}): Promise<Buffer | string> {
    let screenshotType = 'png' as Protocol.Page.CaptureScreenshotRequestFormat;
    ...
    if (options.type) {
      ...
      switch (extension) {
        case 'png':
          screenshotType =
            'png' as Protocol.Page.CaptureScreenshotRequestFormat;
          break;
        case 'jpeg':
        case 'jpg':
          screenshotType =
            'jpeg' as Protocol.Page.CaptureScreenshotRequestFormat;
          break;
        case 'webp':
          screenshotType =
            'webp' as Protocol.Page.CaptureScreenshotRequestFormat;
          break;
        default:
          throw new Error(
